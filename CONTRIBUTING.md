...
Для удобства написания LaTeX кода формул можно использовать [этот](https://www.codecogs.com/latex/eqneditor.php) сайт, позволяющий в удобной форме сотсавлять математические уравнения в коде LaTeX.
